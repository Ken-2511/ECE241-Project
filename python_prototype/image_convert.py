...
if __name__ == '__main__':
    ...
    converted_image = convert_picture("greeting_screen.png", bits_per_color_channel=bits_per_channel,
    ...
    memory = array2memory(converted_image, 1 if monocolor else bits_per_channel, depth, "greeting_screen.mif")
